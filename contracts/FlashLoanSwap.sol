...
import { FlashLoanReceiverBase } from "./interfaces/dYdX/FlashLoanReceiverBase.sol";
import { ILendingPool } from "./interfaces/dYdX/ILendingPool.sol";
import { ILendingPoolAddressesProvider } from "./interfaces/dYdX/ILendingPoolAddressesProvider.sol";
...
contract FlashLoanSwap is FlashLoanReceiverBase {
    ...
    function executeOperation(
        ...
        // WETH -> DAI (amount in borrowed from dYdX)
        ...
        // DAI -> WETH (amount out is owing to dYdX)
        ...
        // approve dYdX pool allowance to transfer back the owed amount
